...
void Lang::setCh() {
	ML.LNAGUAGE = Chinese;
	ML.AUTO_BOOT =L"开机启动";
	ML.ABOUT_TXT = L"FingerGo\n--------------\n作者: Neway\n源码: https://github.com/Neway13/fingerGo.git\n邮箱: lxwlxc@126.com";
	ML.CONFIG = L"配置";
	ML.HELP = L"帮助";
	ML.HELP_DETAIL = L""
		...
		"\n"
		"【FingerGo功能】\n"
		"    帮你将按键与程序绑定，按下按键时快速切换到该程序。例如将 \"W\" 与 \"word程序\" 绑定，按下快捷键\"ALT + W\"即可快速切换到\"word程序\"。同样的一个快捷键，在不同场景下，可以实现启动程序、前置程序、最小化程序、相同程序的不同窗口见来回切换，具体见下面使用场景。\n"
		"\n"
		"【使用场景】\n"
		"下面依然以word程序为例：\n"
